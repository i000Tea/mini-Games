...
class NavMeshPrefabInstanceEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		GUI.enabled = false;
		EditorGUILayout.PropertyField(m_NavMeshDataProp, new GUIContent("寻路网格"));
		GUI.enabled = true;
		EditorGUILayout.PropertyField(m_FollowTransformProp, new GUIContent("跟随Transform"));
	...
	void OnInspectorGUIPrefab(GameObject go)
	{
		...
		{
			if (GUILayout.Button("选择预制资产烘焙或清除导航网格 Select the Prefab asset to bake or clear the navmesh",
