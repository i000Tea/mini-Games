...
namespace Tea.PolygonHit
{
   ...
   public class InputController : ButtonControlBase
   {
      ...
      void AddEvent()
      {
         EventControl.OnAddAntherList(ActionType.PlayerDestory, TouthOver);
      }
      void RemoveEvent()
      {
         EventControl.OnRemoveAhtnerList(ActionType.PlayerDestory, TouthOver);
      }
      #endregion
      ...
      public override void OnEndDrag(PointerEventData eventData)
      {
         ...
         EventControl.InvokeSomething(ActionType.Shoot);
