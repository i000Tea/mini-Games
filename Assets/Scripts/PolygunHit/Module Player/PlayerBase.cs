...
namespace Tea.PolygonHit
{
    ...
    public class PlayerBase : MonoBehaviour
    {
		...
		protected virtual void Start()
		{
			...
			GUIManager.inst.PlayerMessageUpdate(nowLevel, nowExp, maxExp, Health);
		}
        ...
        public void LevelUp()
        {
            ...
            // 升级状态
            GameManager.inst.SetState(GameState.LevelUp);
            // 等级UI更新
            GUIManager.inst.PlayerMessageUpdate(nowLevel, nowExp, maxExp, Health);
        }
        ...
        private IEnumerator IsDestroy()
        {
            ...
            // 等待1秒后
            GUIManager.inst.CanvasSwitch(GameState.Over);
        }
		#endregion
