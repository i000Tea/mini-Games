...
namespace ECM.Components
{
	...
	public sealed class CharacterMovement : MonoBehaviour
	{
		...
		/// </summary>
		/// <param name="direction">目标方向向量。 The target direction vector.</param>
		/// <param name="angularSpeed">最大旋转速度 Maximum turning speed in (deg/s).</param>
		/// <param name="onlyLateral">y轴可以忽略吗? Should the y-axis be ignored?</param>
